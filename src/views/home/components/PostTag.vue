...
.post-tag-inputs .post-tag {
  // flex: 1 1 auto;
  text-align: center;
}

.post-tag-inputs .post-tag input {
  display: none;
}

.post-tag-inputs .post-tag .name {
  display: flex;
  cursor: pointer;
  align-items: center;
  justify-content: center;
...
.post-tag-inputs .post-tag input:hover + .name {
  // background-color: #fff;
  background-color: #e9ecef;
  color: #409eff;
}

.post-tag-inputs .post-tag input:checked + .name {
  // background-color: #fff;
