  ...
  <div class="introduce-container">
    <div class="introduce-text-container">
      ...
      <div class="intro-bg-img01">
        <img src="@/assets/img/Coding _Two Color.png" alt="代码" />
      </div>
      <div class="intro-bg-img02">
        <img src="@/assets/img/Java_Two Color.png" alt="代码" />
      </div>
      <div class="intro-bg-img03">
        <img src="@/assets/img/Python_Flatline.png" alt="代码" />
      </div>
      <div class="intro-bg-img04">
        <img src="@/assets/img/Javascript_Two Color.png" alt="代码" />
      </div>
    ...
    <div v-show="introMenuActive === 'intro__project'">
      ...
      <div class="intro-light-sharing">
        <div class="light-sharing-left">
          <lottie-vue-player
            src="https://assets8.lottiefiles.com/packages/lf20_9ti102vm.json"
            :player-size="lottieOptions.playerSize"
            :player-controls="lottieOptions.playerControl"
      ...
      <div class="intro-skill-stack">
        <div class="skill-container">
          ...
          <div class="skill-intro" v-if="btnActive === 'vue'">
            ...
            >
              <div class="swiper-wrapper">
                <div class="swiper-slide swiper-slide1 skill-intro-item">
          ...
          <div class="skill-intro" v-if="btnActive === 'java'">
            ...
            <div class="swiper-container swiper-container-java">
              <div class="swiper-wrapper">
                <div class="swiper-slide swiper-slide1 skill-intro-item">
          ...
          <div class="skill-intro" v-if="btnActive === 'hyperledger'">
            ...
            <div class="swiper-container swiper-container-hyperledger">
              <div class="swiper-wrapper">
                <div class="swiper-slide swiper-slide1 skill-intro-item">
    ...
    <div class="contact-us">
      ...
      <div class="contact-us-right">
        <lottie-vue-player
          src="https://assets4.lottiefiles.com/packages/lf20_kdx6cani.json"
          :player-size="lottieOptions.playerSize"
          :player-controls="lottieOptions.playerControl"
          :autoplay="lottieOptions.autoplay"
          :loop="lottieOptions.loop"
...
export default {
  ...
  data() {
    return {
      btnActive: "vue",
      introMenuActive: "intro__project",
      introMenuList: [
        {
          name: "项目介绍",
  ...
  mounted() {
    ...
    // console.log(this.$refs.introMenu);

    this.getCollegeListInfo();
    this.$nextTick(() => {
      // 默认展示第一个
      this.clickMenu(0, "intro__project");
    });
  },
  methods: {
    // 获取加入高校
    ...
    //
    clickMenu(index, activeName) {
      // console.log(index);
      // console.log(this.$refs[`introMenu_`]);
      // 切换颜色
      for (let i = 0; i < this.$refs[`introMenu_`].length; i++) {
        if (i === index) {
          this.$refs[`introMenu_`][i].className = "intro-menu-item active";
        } else {
          this.$refs[`introMenu_`][i].className = "intro-menu-item";
        }
      }

      // 导航切换
      this.introMenuActive = activeName;
    },
  },
};
</script>
